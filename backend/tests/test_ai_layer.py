...
def test_trim_narrative_preserves_decimals_and_clause_refs():
    raw = (
        "Your website scored 67.9% against ICTA.6.003:2023. "
    ...
    assert "ICTA.6.003:2023" in trimmed
...
def test_generate_scan_narrative_preserves_score_decimals():
    with patch(
        ...
        return_value=(
            "Your website achieved a compliance score of 67.9% against ICTA.6.003:2023. "
    ...
    assert "67.9%" in text
    assert "ICTA.6.003:2023" in text
